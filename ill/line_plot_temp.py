...
def create_df_bright():
        ...
        'RSME':  [0.229, 0.327, 0.357, 0.422, 0.454],
        'NSC':   [0.103,  0.189,  0.234, 0.254,0.270]
        }
...
def create_df_ppi():
        raw_data = {'method_name': ['100', '150', '200', '250','300'],
        'RSME':  [0.017, 0.105, 0.207, 0.256, 0.297],
        'NSC':   [0.01,  0.057,  0.089, 0.129,0.139]
        }
        df = pd.DataFrame(raw_data, columns = ['method_name']+methods)
...
def make_line_plot(df,fig,ax,data):
        ...
        if data=="ppi":
            ...
            locSet="best"
        ax.legend(methods, loc=locSet,ncol=1,numpoints=1)
        #setting label
